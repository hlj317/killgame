...
var config = {
    ...
    colors: ['#1d67ca', '#f7a35c', '#434348', '#90ed7d', '#f15c80', '#8085e9'],
...
function calValidDistance(distance, chartData, config, opts) {
    ...
    var dataChartAreaWidth = opts.width - config.padding - chartData.xAxisPoints[0] - 65;
...
function getXAxisPoints(categories, opts, config) {
    ...
    var dataCount = opts.enableScroll ? Math.min(20, categories.length) : categories.length;
...
function drawXAxis(categories, opts, config, context) {
    ...
    var ratio = 1 || Math.ceil(categories.length / maxXAxisListLength);
